...
function sendIntakeForm(name, email, programName) {
  ...
  var sig =
    ...
    + '<img src="https://innerevolutionyoga.life/images/signature/NicoSchlagerProfileYoga.png" width="82" style="display:block;" />'
    + '</td>'
    ...
    + '<table cellpadding="0" cellspacing="0" border="0"><tr>'
    + '<td style="padding-right:10px;"><a href="https://wa.me/qr/3CTAALSBOSBXH1" target="_blank"><img src="https://innerevolutionyoga.life/images/signature/icon_whatsapp.png" width="22" height="22" style="display:block;" /></a></td>'
    + '<td style="padding-right:10px;"><a href="https://www.instagram.com/innerevolution.yoga?igsh=dGdmdjNtN21reWd3" target="_blank"><img src="https://innerevolutionyoga.life/images/signature/icon_instagram.png" width="22" height="22" style="display:block;" /></a></td>'
    + '<td><a href="https://innerevolutionyoga.life/de" target="_blank"><img src="https://innerevolutionyoga.life/images/signature/icon_globe.png" width="22" height="22" style="display:block;" /></a></td>'
    + '</tr></table>'
    + '</td>'
    + '<td style="padding:16px 16px 16px 0;vertical-align:middle;width:82px;text-align:center;">'
    + '<img src="https://innerevolutionyoga.life/images/signature/Logo%20Mystical%20Simple%20Cut%20Reduced.png" width="72" style="display:block;" />'
    + '</td>'
    + '</tr>'
